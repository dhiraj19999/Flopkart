...
function BeforeFooter() {
  return (
    <div>
      ...
      >
        <Text fontSize={"14px"} pb="9px" fontWeight={"bold"} textAlign={"left"}>
          {" "}
          Top Stories:Brand Directory
        </Text>
        <Text fontSize={"12px"} pb="9px" textAlign={"left"}>
          {" "}
          MOST SEARCHED FOR ON FLIPKART:Flipkart Axis Bank Super Elite Credit
          cardPrimebook LaptopsBounce Infinity E1Buy Laptop on EMIInfinix Zero
          Book UltraOPPO Reno8 5GOPPO Reno8 Pro 5GFresh Flower BouquetHoli
          HampersHoli GiftsBouquetOneplus MonitorsSell Old Mobile PhonesPremium
          LaptopsElectronics StorePhone coverVivo Y33TInfinix Y1 PlusOkaya
          Electric Vehiclesbgauss electric scooterOPPO Reno7 Pro 5GiPhone
          13iPhone 13 ProiPhone 13 Pro MaxiPhone 13 MiniGoogle Pixel 6a
          ...
          Bank Credit CardFlipkart Pay Later MOBILES:iPhone 12 64GBiPhone 12 Pro
          512GBiPhone 12 128GBVivo Y91iVivo Y11Vivo Y15Vivo Y50Vivo Y12Reno2
          FOppo A12Oppo F15Oppo A31Samsung A71Samsung A51Samsung A31Realme
          X2iPhone 11iPhone 11 ProMobile CoverMobile Offersiphone x4G
          ...
          DSLRNikon DSLR LAPTOPS:MacBook Pro M2Premium Laptopacer Ryzen 3 Dual
          ...
          Book Prime Core i5 11th GenMicrosoft Surface Go Pentium 128GBBranded
          ...
          laptops 2022HP latest laptops 2022Infinix INBook X1 Neo Series Celeron
          Quad Core - (8 GB/256 GB SSD/Windows 11 Home) XL22 Thin and Light
          LaptopMicrosoft Laptops12th Gen Intel Core Laptops TVS:Nokia
          TVPanasonic TVThomson TVVu TVRealme TVMotorola TVOnePlus TVsLG
          ...
          KurtisTrack PantMen KurtasGym WearParty DressesPalazzo SuitsBoys
          ...
          SkirtsCorset tops camisolesWomen magenta earringsNo collar
          jacketsGreen dress materialBlack patiala kurta setMen camel shoes
          casualBlack pathaniTassel SareesKhaki dressesKids formal dressesMauve
          shirtsWomen henleyuppada pattu sareesLeopard dressesSleeveless shrugs
          ...
          SofaBrown Sofa BGMH:Whey ProteinHomeopathyBounce InfinityValentine
          Gift for BoyfriendValentine Gift for GirlfriendValentines Day
          GiftsChristmas GiftsCalendar 2023Online GuitarBooks StoreMusical
          Instrument StoreDabur ChyawanprashBaidyanath ChyawanprashEnergy
          DrinksToysMilk Drink MixesRakhiChyawanprashIndian FlagProtein
          Supplements
        </Text>
