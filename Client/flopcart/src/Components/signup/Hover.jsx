...
const Hover = () => {
  ...
  >
    ...
    <Flex h="56px" justifyContent="space-between">
                ...
                <hr />
                <Flex cursor={'pointer'} className="pop1" h='49px' fontSize='14px'><Center ml='10px'><Image src="https://flipkart-clone-project-m.netlify.app/static/media/icon1.0ffedd5289232ef3421f490990184573.svg" alt="vikas" /></Center> <Center ml='16px'>Flipkart Plus Zone</Center></Flex>
                <hr />
                <Flex  cursor={'pointer'}  h="49px" fontSize='14px' className="pop1"  > 
                      <Center ml='10px'>
