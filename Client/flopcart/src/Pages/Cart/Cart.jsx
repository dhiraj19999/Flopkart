...
import { removeItemFromCart } from "../../redux/cartReducer/action";
...
if(cartItems.length===0){
   return(
    <Box  w="100%" bg="#f1f3f6" h="150vh" pt="70px"  >
        ...
        ><Text color="blue" fontSize="20" fontWeight="400"> Flopkart  </Text>
      </Box>
      <Box display='block' > 
        <Box
      ...
      <Box  w="200px" m="auto" textAlign={"center"}> 
           <Text  mt='-142px' fontWeight='400' fontSize='18px' > Looks like your cart is empty!</Text>
           <Text  fontWeight='400' fontSize='13px' >Add items to it now.</Text>
        <NavLink to="/"  > <Button  color='white' bg='#2874f0'  _hover={{ bg: '#fb641b' }} borderRadius='0' mt='4' pl='16' pr='16' >
              Shop now
            </Button> </NavLink>
            </Box>
